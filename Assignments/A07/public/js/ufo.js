...
this.nextFire = 0;
    ...
    this.create = function (x, y, x_scale, y_scale) {
        ...
        this.xScale = x_scale;
        this.yScale = y_scale;
        this.ship = game.add.sprite(x, y, 'space1');
        this.ship.animations.add('m',0,7)
      
        this.ship.play('m',10,true)
     //   this.ship1 = game.add.sprite(x, y, this.atlasName);
       ...
       tap = game.input.activePointer.isDown;
    	...
    	// Left mouse is down or finger on screen
		 if (tap) {
            //this._move();
          //  this._zeroAngle();
       this.posx=game.input.activePointer.x;
          this.posy=game.input.activePointer.y;
          this.tapped=true
    ...
    this.fireBullets = function () {
        ...
        console.log("bullet")
        var angle = Math.atan2(this.posy - this.ship.y, this.posx - this.ship.x) * 180 / Math.PI;
        ...
        if (bullet) {
            if(this.tapped==true){
                ...
                bullet.angle = angle;
                bullet.body.velocity.setTo(xSpeed, ySpeed);
