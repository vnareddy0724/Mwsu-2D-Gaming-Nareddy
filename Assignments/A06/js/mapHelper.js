...
MapHelper.prototype.getTileProperties1 = function(key,x,y){
    console.log(this.layers[key]);
    var x1 = this.layers[key].getTileX(x);
    var y1 = this.layers[key].getTileY(y);
    console.log(x,y)

    return  this.map.getTile(x1, y1, this.layers[key]);
