function Ufo(game_copy) {
    ...
    this.preLoad = function (atlas_name, sprite_sheet, atlas_json) {
        ...
        game.load.image('bullet', 'images/muzzleflash6.png')
    ...
    this.create = function () {
        ...
        //More bullets are generated based on the score
        console.log(game.global.score+"score")
        ...
        this.bullets.callAll('anchor.setTo', 'anchor', 0, 0);
        this.bullets.callAll('scale.setTo', 'scale', 0.2, 0.3);
        this.bullets.callAll('body.setSize', 'body', 10, 10);
	...
	this.fireBolt = function(){
		this.laserSprites.buildUp.alpha = 0;
		this.laserSprites.bolt.alpha  = 10;
    ...
    this.fireBullets = function() {
        ...
        if (bullet) {
            ...
            bullet.reset(this.ship.x, this.ship.y + 0);
